...
out.print(sb);*/
 ...
 fn=saveFile;
 saveFile = "D:\\imagezapper\\web\\gallery\\" + saveFile;
...
%>
<%
	//response.sendRedirect("fileup.jsp?file="+fn);
	//response.sendRedirect("categaryadd.jsp");
       //response.sendRedirect("gallerycat.jsp");
      response.sendRedirect("gallery.jsp?cid="+request.getParameter("cid"));
