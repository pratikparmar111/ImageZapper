    ...
    <body>
        ...
        <%
            if (request.getParameter("submit") != null) {
                Object unm = session.getAttribute("adminuser");
                ...
                if (unm != null) {
                    ...
                    rs = stmt.executeQuery("select * from admin where username='" + unm + "' ");
                    ...
                    if (pwdold.equals(pwdoldtype)) {
                        ...
                        int c = stmt2.executeUpdate("update admin SET password='" + pwdnew + "'WHERE username='" + unm + "' ");
        ...
        <form method="post">
            ...
            <table>
                Old Password
                <input type="password" name="txtoldpwd" id="txtoldpwd" required="required" /></br>
